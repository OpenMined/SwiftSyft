...
class SyftClientTests: XCTestCase {
    ...
    func test_init(){
        ...
        XCTAssertNotNil(SyftClient(url: URL(string: "ws://test.com:5000")!))
        XCTAssertNotNil(SyftClient(url:URL(string: "ws://test.com:5000")!, authToken: "test_auth"))
        XCTAssertNotNil(SyftClient(url: URL(string: "wss://test.com:5000")!))
        XCTAssertNotNil(SyftClient(url:URL(string: "wss://test.com:5000")!, authToken: "test_auth"))
    }
    func test_newjob_ws_Auth(){
        let syftClient_ws_Auth = SyftClient(url: URL(string: "ws://test.com:5000")!, authToken: "test_auth")
        XCTAssertNotNil(syftClient_ws_Auth?.newJob(modelName: "mnist", version: "1.0.0-A"))
    }
    func test_newjob_ws_NoAuth(){
        let syftClient_ws_NoAuth = SyftClient(url: URL(string: "ws://test.com:5000")!)
    ...
    func test_newjob_wss_Auth(){
        let syftClient_wss_Auth = SyftClient(url: URL(string: "wss://test.com:5000")!, authToken: "test_auth")
        XCTAssertNotNil(syftClient_wss_Auth?.newJob(modelName: "mnist", version: "1.0.0-A"))
    }
    func test_newjob_wss_NoAuth(){
        let syftClient_wss_NoAuth = SyftClient(url: URL(string: "wss://test.com:5000")!)
